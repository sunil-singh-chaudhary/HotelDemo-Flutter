  ...
  group(
    ...
    () {
      ...
      setUp(() {
        ...
        when(() => users.first.name).thenReturn(user_name);
                    ...
                    isA<List<User>>()
                        ...
                        .having(
                            ...
                            isA<User>()
                                ...
                                .having((u) => u.name, 'compare onebyone',
                                    user_name)
      ...
      group('refresh Updates', () {
        ...
        blocTest<UsersCubit, UsersState>('emits [success] when it is updated',
            setUp: () {
              when(() => userrepo.getUsers()).thenAnswer((realInvocation) =>
                  Future.value(
                      const [User.empty(), User.empty(), User.empty()]));
            },
            build: () => UsersCubit(userrepo),
            ...
            expect: () => [
                  // [ errror here we need list not only userlist but listof userlist
